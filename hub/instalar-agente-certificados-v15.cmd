@echo off
setlocal
title DocPronto - Agente de Certificados V15
color 0F

echo.
echo =============================================
echo       DOCPRONTO - AGENTE DE CERTIFICADOS V15
echo =============================================
echo.
echo Esta versao conecta o A3 pelo Schannel do Windows.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/Nikodeimus/DocPronto/main/server-cert-v8.mjs?v=cert-15' -OutFile '%AGENT_DIR%\server-cert-v15.mjs' } catch { Write-Host $_.Exception.Message; exit 1 }"
if errorlevel 1 (
...
start "DocPronto - Agente V15 (mantenha aberto)" /D "%AGENT_DIR%" cmd /k "set PORT=4174&& node server-cert-v15.mjs"
timeout /t 3 /nobreak >nul
start "" "https://nikodeimus.github.io/DocPronto/hub/?v=cert-15"

echo.
echo Agente de certificados V15 iniciado. Mantenha a nova janela aberta.
