...
echo.
echo ============================================
echo       DOCPRONTO - AGENTE LOCAL A3 V4
echo ============================================
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/Nikodeimus/DocPronto/main/server-a3-v4.mjs' -OutFile '%AGENT_DIR%\server-a3-v4.mjs' } catch { Write-Host $_.Exception.Message; exit 1 }"
if errorlevel 1 (
...
start "DocPronto - Agente A3 (mantenha aberto)" /D "%AGENT_DIR%" cmd /k "set PORT=4174&& node server-a3-v4.mjs"
timeout /t 3 /nobreak >nul
start "" "https://nikodeimus.github.io/DocPronto/hub/?v=dfe-8"

echo.
echo Agente V4 iniciado. Mantenha a nova janela aberta
