@echo off
setlocal
title DocPronto - Agente de Certificados V12
color 0F

echo.
echo =============================================
echo       DOCPRONTO - AGENTE DE CERTIFICADOS V12
echo =============================================
echo.
echo Esta versao usa conexao direta do Windows
echo para consultar a SEFAZ com o A1 instalado.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/Nikodeimus/DocPronto/main/server-cert-v8.mjs?v=cert-12' -OutFile '%AGENT_DIR%\server-cert-v12.mjs' } catch { Write-Host $_.Exception.Message; exit 1 }"
if errorlevel 1 (
...
start "DocPronto - Agente V12 (mantenha aberto)" /D "%AGENT_DIR%" cmd /k "set PORT=4174&& node server-cert-v12.mjs"
timeout /t 3 /nobreak >nul
start "" "https://nikodeimus.github.io/DocPronto/hub/?v=cert-12"

echo.
echo Agente de certificados V12 iniciado. Mantenha a nova janela aberta.
