@echo off
setlocal
title DocPronto - Agente de Certificados V16
color 0F

echo.
echo =============================================
echo       DOCPRONTO - AGENTE DE CERTIFICADOS V16
echo =============================================
echo.
echo Esta versao valida o leitor e o PIN antes da SEFAZ.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/Nikodeimus/DocPronto/main/server-cert-v8.mjs?v=cert-16' -OutFile '%AGENT_DIR%\server-cert-v16.mjs' } catch { Write-Host $_.Exception.Message; exit 1 }"
if errorlevel 1 (
...
start "DocPronto - Agente V16 (mantenha aberto)" /D "%AGENT_DIR%" cmd /k "set PORT=4174&& node server-cert-v16.mjs"
timeout /t 3 /nobreak >nul
start "" "https://nikodeimus.github.io/DocPronto/hub/?v=cert-16"

echo.
echo Agente de certificados V16 iniciado. Mantenha a nova janela aberta.
