@echo off
setlocal
title DocPronto - Agente de Certificados V14
color 0F

echo.
echo =============================================
echo       DOCPRONTO - AGENTE DE CERTIFICADOS V14
echo =============================================
echo.
echo Esta versao possui modo proprio para certificado A3.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/Nikodeimus/DocPronto/main/server-cert-v8.mjs?v=cert-14' -OutFile '%AGENT_DIR%\server-cert-v14.mjs' } catch { Write-Host $_.Exception.Message; exit 1 }"
if errorlevel 1 (
...
start "DocPronto - Agente V14 (mantenha aberto)" /D "%AGENT_DIR%" cmd /k "set PORT=4174&& node server-cert-v14.mjs"
timeout /t 3 /nobreak >nul
start "" "https://nikodeimus.github.io/DocPronto/hub/?v=cert-14"

echo.
echo Agente de certificados V14 iniciado. Mantenha a nova janela aberta.
