@echo off
setlocal
title DocPronto - Agente de Certificados V11
color 0F

echo.
echo =============================================
echo       DOCPRONTO - AGENTE DE CERTIFICADOS V11
echo =============================================
echo.
echo Esta versao corrige o tempo de conexao da
echo consulta com A1 instalado no Windows.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/Nikodeimus/DocPronto/main/server-cert-v8.mjs?v=cert-11' -OutFile '%AGENT_DIR%\server-cert-v11.mjs' } catch { Write-Host $_.Exception.Message; exit 1 }"
if errorlevel 1 (
...
start "DocPronto - Agente V11 (mantenha aberto)" /D "%AGENT_DIR%" cmd /k "set PORT=4174&& node server-cert-v11.mjs"
timeout /t 3 /nobreak >nul
start "" "https://nikodeimus.github.io/DocPronto/hub/?v=cert-11"

echo.
echo Agente de certificados V11 iniciado. Mantenha a nova janela aberta.
