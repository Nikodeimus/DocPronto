...
echo.
echo ============================================
echo       DOCPRONTO - AGENTE DE CERTIFICADOS V7
echo ============================================
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/Nikodeimus/DocPronto/main/server-cert-v7.mjs' -OutFile '%AGENT_DIR%\server-cert-v7.mjs' } catch { Write-Host $_.Exception.Message; exit 1 }"
if errorlevel 1 (
...
start "DocPronto - Agente A3 (mantenha aberto)" /D "%AGENT_DIR%" cmd /k "set PORT=4174&& node server-cert-v7.mjs"
timeout /t 3 /nobreak >nul
start "" "https://nikodeimus.github.io/DocPronto/hub/?v=cert-7"

echo.
echo Agente de certificados V7 iniciado. Mantenha a nova janela aberta
