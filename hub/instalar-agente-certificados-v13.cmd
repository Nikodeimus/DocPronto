@echo off
setlocal
title DocPronto - Agente de Certificados V13
color 0F

echo.
echo =============================================
echo       DOCPRONTO - AGENTE DE CERTIFICADOS V13
echo =============================================
echo.
echo Esta versao usa o A1 instalado somente em
echo memoria e conecta a SEFAZ pelo motor Node.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/Nikodeimus/DocPronto/main/server-cert-v8.mjs?v=cert-13' -OutFile '%AGENT_DIR%\server-cert-v13.mjs' } catch { Write-Host $_.Exception.Message; exit 1 }"
if errorlevel 1 (
...
start "DocPronto - Agente V13 (mantenha aberto)" /D "%AGENT_DIR%" cmd /k "set PORT=4174&& node server-cert-v13.mjs"
timeout /t 3 /nobreak >nul
start "" "https://nikodeimus.github.io/DocPronto/hub/?v=cert-13"

echo.
echo Agente de certificados V13 iniciado. Mantenha a nova janela aberta.
